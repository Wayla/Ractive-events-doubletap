...
(function ( global, factory ) {
  ...
  // browser global
    ...
    throw new Error( 'Could not find Ractive! It must be loaded before the doubletap plugin' );
  }
  ...
  var doubletap = function ( node, fire ) {
  ...
  Ractive.events.doubletap = doubletap;
